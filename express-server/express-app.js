//In the CRUD lab you performed CRUD operations on transient data by creating API endpoints with an Express Server. 
//In this lab, you will restrict these operations to authenticated users using JWT and session authentication.

//In this lab, the friends object will be a JSON/dictionary with email as the key and friends object as the value. 
//The friends object is a dictionary with firstName,lastName, DOB mapped to their respective values. 
//You will thus be using “body” from the HTTP request instead of “query” and “params”.
...
//you need to provide a way to register the users. This endpoint will be a post request that accepts username and password through the body. 
...
//to avoid duplications and keep the username unique. This is a utility function and not an endpoint.
